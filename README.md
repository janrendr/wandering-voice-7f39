...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/wandering-voice-7f39)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/wandering-voice-7f39
```

A live public deployment of this template is available at [https://wandering-voice-7f39.templates.workers.dev](https://wandering-voice-7f39.templates.workers.dev)
